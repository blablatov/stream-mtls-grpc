...
// Source: github.com/blablatov/stream-grpc/mtls-proto (interfaces: ProductInfoClient)

// Package mock_mtls_proto is a generated GoMock package.
...
import (
	...
	__ "github.com/blablatov/stream-mtls-grpc/mtls-proto"
...
func (m *MockProductInfoClient) AddProduct(arg0 context.Context, arg1 *__.Product, arg2 ...grpc.CallOption) (*__.ProductID, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductInfoClient) GetProduct(arg0 context.Context, arg1 *__.ProductID, arg2 ...grpc.CallOption) (*__.Product, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
